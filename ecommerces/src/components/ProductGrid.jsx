...
export default function ProductGrid({ products: visibleProducts, category, onCategoryChange, onViewProduct, onAddToCart, onBuyNow, search }) {
  return <section className="catalog">
    <div className="catalog-intro"><div><p className="eyebrow">Autumn collection</p><h1>Useful things for a considered home.</h1><p>Small-batch furniture, homeware, and everyday essentials made from honest materials.</p></div><span className="catalog-count">36 objects in stock</span></div>
